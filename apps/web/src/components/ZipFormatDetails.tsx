	...
	return (
		<details class="mb-4 text-sm">
			...
			<div class="mt-2 p-3 bg-gray-50 rounded border border-gray-200 text-gray-700">
				...
				<p class="mt-2 mb-2">
					The files must be at the top level of the zip, not inside a folder.
					Compressing a folder in Finder or File Explorer nests the files in a folder inside the zip, and the tool won't find them.
					To create a valid zip from the command line, run this from inside the folder containing the files:
				</p>
				<pre class="bg-gray-800 text-gray-100 rounded p-3 overflow-x-auto"><code>zip ../my-firmware.zip flash.bin uicr.bin</code></pre>
