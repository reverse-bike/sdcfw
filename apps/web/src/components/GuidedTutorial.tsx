					...
					<div class="flex">
						...
						<div class="ml-3">
							<p class="text-sm text-blue-700">
								<strong>Note:</strong> After restoring firmware, you may need to delete the bike from your phone's Bluetooth list of known devices before it will connect again. Go to your phone's Bluetooth settings, find the bike, and "Forget" or remove it, then pair again.
							</p>
						</div>
					</div>
				</div>
