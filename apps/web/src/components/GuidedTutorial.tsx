  ...
  return (
    <div class="space-y-8 pl-4">
      ...
      >
        <div class="mb-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <figure>
              ...
              <figcaption class="text-sm text-gray-500 mt-2 text-center">
                Terminal 8 on the white connector for GND. You may need some tape to keep this wire
                in place.
              </figcaption>
            </figure>
          </div>
        ...
        <div class="border-t border-gray-200 pt-6">
          ...
          <p class="text-gray-600 text-sm mb-4">
            ...
            <span class="font-bold">Unmute your speakers</span> to hear feedback noises.
          </p>
      ...
      <ToolStep
        ...
        description={
          <>
            Use this tool to restore your original backup if something goes wrong, or to flash{" "}
            <a href="/firmware" target="_blank" class="text-blue-500 hover:underline">
              custom firmware
            </a>
            . Select your ZIP file, arm the tool, then press and hold the wires to the test points
      ...
      >
        <div class="mb-4">
          <Callout type="warning" title="Warning">
            This tool provides low-level access to your device firmware. Always backup before making
            changes.
          </Callout>
        </div>
        <div class="mb-4">
          <Callout type="info" title="Note">
            After restoring firmware, you may need to delete the bike from your phone's Bluetooth
            list of known devices before it will connect again. Go to your phone's Bluetooth
            settings, find the bike, and "Forget" or remove it, then pair again.
          </Callout>
        </div>
        <ZipFormatDetails />
