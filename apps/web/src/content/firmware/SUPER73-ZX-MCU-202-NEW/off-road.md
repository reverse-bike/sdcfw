---
name: Mode 4 Unlock
path: /cfw/SUPER73-ZX-MCU-202-NEW-off-road-r203-v1.0.2.zip
...
Requires setting the bike into mode 4 to activate full power. Works with controllers labeled `SUPER73_ZX_US_V2_H102_F201`.
